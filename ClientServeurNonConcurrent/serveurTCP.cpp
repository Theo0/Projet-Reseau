...
if(descBrCv == -1) {
 ...
 if(!strcmp(tamponOrdre, "reception")){
    ...
    //ENVOI DE FICHIER PAR LE SERVEUR**************************************************************
    ...
    //FIN EVNOI DE FICHIER PAR LE SERVEUR***************************************************************
    else if(!strcmp(tamponOrdre, "envoi")){
      //RECEPTION DES FICHIERS PAR LE SERVEUR **********************************************************
      cout << "on est dans l'autre ordre" << endl;
      ...
      //FIN RECEPTION DES FICHIERS PAR LE SERVEUR ******************************************************
    }
    else{
          cout << "Instruction inconnue reçue : Non traitée" << endl;
        }
    }    
  }
} 
